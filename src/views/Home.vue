<template>
  ...
  // For development only - replace with actual images
  ...
  export default {
    ...
    data() {
      return {
        ...
        documentationCards: [
          {
            title: 'Penyuluhan Diabetes',
            description: 'Kegiatan penyuluhan tentang pencegahan dan penanganan diabetes mellitus',
            image: placeholderImageUrls[0]
          },
          {
            title: 'Pengukuran Tekanan Darah',
            description: 'Pemeriksaan tekanan darah rutin untuk masyarakat',
            image: placeholderImageUrls[1]
          },
          {
            title: 'Pengecekan Gula Darah',
            description: 'Skrining gula darah untuk deteksi dini diabetes',
            image: placeholderImageUrls[2]
          },
          {
            title: 'Konsultasi Kesehatan',
            description: 'Konsultasi kesehatan dengan tenaga medis profesional',
            image: placeholderImageUrls[3]
          },
          {
            title: 'Pelatihan Kader',
            description: 'Pelatihan kader kesehatan untuk pendampingan pasien',
            image: placeholderImageUrls[4]
          },
          {
            title: 'Senam Sehat',
            description: 'Kegiatan olahraga rutin untuk menjaga kesehatan',
            image: placeholderImageUrls[5]
          }
        ]
      };
    },
    setup() {
      ...
      onMounted(() => {
        ...
        const section = document.querySelector('.documentation-section');
        if (section) {
