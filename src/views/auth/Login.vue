<!-- views/auth/LoginPageTemplate.vue -->
<template>
    <div class="login-container">
      <div class="login-card">
        ...
        <div class="left-section">
          ...
          <!-- Placeholder Image - Only visible on desktop -->
        ...
        <div class="right-section">
          <div class="form-container">
            ...
            <div class="form-group">
              <div class="input-with-icon" :class="{ 'input-active': isUsernameActive, 'input-error': errors.username }">
            ...
            <!-- Password Input -->
            <div class="form-group">
              <div class="input-with-icon" :class="{ 'input-active': isPasswordActive, 'input-error': errors.password }">
                <div class="icon-container">
        ...
        setTimeout(() => {
          ...
          if (this.credentials.username === 'admin' && this.credentials.password === 'password') {
            ...
            setTimeout(() => {
              ...
              alert('Login berhasil! Redirect to dashboard...');
              this.isLoading = false;
            }, 500);
          } else {
            // Example error scenario
            this.shakeLoginCard();
            this.errors.general = 'Username atau password salah.';
            this.isLoading = false;
          }
